  ...
  return (
    <div className={styles.container}>
      <div className={styles.titleContainer}>
        <h3 className={styles.title}>DESARROLLOS</h3>
      ...
      <div className={styles.bottom}>
        <div className={styles.typeCardContainer}>
          <TypeCard img={Office} title={'OFICINAS'} description={'Construcción de espacios comerciales diseñados para albergar empresas y organizaciones.'} />
        </div>
        <div className={styles.typeCardContainer}>
